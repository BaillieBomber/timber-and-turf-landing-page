    ...
    <div className="min-h-screen bg-[#f7f5f0] text-slate-900">
      ...
      <main className="relative z-20">
        ...
        <section className="relative overflow-hidden py-20 md:py-32">
          {/* Dark scrim — stays dark through the full text area, easing off only at the base */}
          <div className="absolute inset-0 bg-gradient-to-b from-black/55 via-black/45 to-black/25 pointer-events-none" aria-hidden="true" />
